...
git clone https://github.com/jituthejack/emp-management.git
Open the project in IDE (STS / IntelliJ)
...
Jack
Java Developer | Springboot | Spring Data JPA | Hibernate | MySQL | REST APIs | Postman (API Testing)
